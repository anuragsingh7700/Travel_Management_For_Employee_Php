...
require("res/db.php");
$conn = dbconnect();
$sql = "SELECT * from employee_details where id =". $_SESSION["id"];
          ...
          <li class="nav-item p-2">
            <div class="btn-group">
              ...
              <div class="dropdown-menu">
                ...
                <a class="dropdown-item bg-secondary" href="#">Update Profile</a>
      ...
      <div>
        ...
        <form method="POST" action="controllers/empupdatecontrol.php">
            <table class=" table text-center col-lg-10 col-md-10  mx-auto text-white">
              ...
              <tr >
                <td>Phone Number</td>
                <td><input type="text" class="form-control" name="phone_no" value='<?php echo $row["phone_no"];?>'></td>
              </tr>
              <tr >
                <td>Address</td>
              ...
              <tr >
                <td>Pincode</td>
                <td><input type="text" class="form-control" name="pincode" value='<?php echo $row["pincode"];?>'></td>
              </tr>
              <tr>
